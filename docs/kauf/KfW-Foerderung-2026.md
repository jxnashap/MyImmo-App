...
> **Goldene Regel bei fast allen Programmen:** Der Antrag muss **VOR Vorhabenbeginn** gestellt werden (bei Kauf = vor Notarvertrag; bei Bau/Sanierung = vor Auftragsvergabe/Baubeginn). Zu spät = Förderung weg. KfW-Kredite laufen über deine **Hausbank/einen Finanzierungspartner**, nicht direkt bei der KfW.

---

## Übersichtstabelle

| Programm | Träger | Zweck | Höhe (Stand 07/2026) | Selbstnutzung | Einkommensgrenze | Kinder | Energiestandard | Antrag vor Beginn |
|---|---|---|---|---|---|---|---|---|
...
## „Kommt in Frage, wenn …" — je Programm

### KfW 124 — KfW-Wohneigentumsprogramm (Kredit bis 100.000 €)
**Gefördert:** Kauf oder Bau von selbstgenutztem Wohneigentum (Kaufpreis, Bau-/Nebenkosten). Kein Energiestandard nötig.
**Kommt in Frage, wenn:** du das Objekt **selbst bewohnst** (oder unentgeltlich an Angehörige überlässt) **und** den Antrag **vor Kaufvertrag/Baubeginn** stellst. Keine Einkommens-/Kindergrenze — der breiteste KfW-Basiskredit. Nicht für Ferien-/Zweitwohnung zur Vermietung.

### KfW 300 — Wohneigentum für Familien (WEF), Neubau
**Gefördert:** zinsverbilligter Kredit für den **Neubau/Ersterwerb** einer klimafreundlichen, selbstgenutzten Wohnung. Höchstbeträge gestaffelt: 1–2 Kinder 170.000 € (mit QNG 220.000 €), 3–4 Kinder 200.000 € (250.000 €), ab 5 Kinder 220.000 € (270.000 €).
...
**Gefördert:** **20 %** der Kosten einer energetischen Einzelmaßnahme, verteilt über 3 Jahre (Jahr 1+2 je 7 %, Jahr 3: 6 %), max. **40.000 € pro Objekt**. Läuft über die **Steuererklärung/Finanzamt**, nicht über einen Vorab-Antrag.
**Kommt in Frage, wenn:** das Gebäude **> 10 Jahre** alt, **ausschließlich selbstgenutzt** ist und eine **Bescheinigung des Fachunternehmens** vorliegt. **Keine Doppelförderung:** entweder § 35c **oder** BAFA/KfW-Zuschuss für dieselbe Maßnahme — nicht beides. Vermieter setzen Sanierung stattdessen als Werbungskosten/AfA ab (das ist eine **Steuerfrage — keine Steuerberatung durch MyImmo**).

---

## Ableitungslogik für MyImmo (aus Objekt-/Haushaltsdaten)

- **Neubau + Kinder + Einkommen ≤ 90k → KfW 300** prüfen; sonst/über Grenze oder Vermietung **→ KfW 297/298**; ohne Standard-Nachweis fallback **→ KfW 124**.
- **Bestandskauf + Kinder + Einkommen ≤ 90k + Energieklasse F/G/H → KfW 308.**
- **Bestandskauf ohne Familien-Kriterien → KfW 124.**
- **Sanierung Gesamtpaket (Zielstandard EH) → KfW 261;** einzelne Maßnahmen an Hülle/Technik **→ BAFA BEG EM;** Heizung **→ KfW 458.**
- **Selbstnutzer, will Steuer statt Zuschuss → § 35c** (Gegenrechnung, nie beides).
- Immer prüfbar machen: **Selbstnutzung ja/nein, Antrag vor Vorhabenbeginn möglich, Kinderzahl < 18, zu versteuerndes Haushaltseinkommen, Energiestandard/-klasse, Objektalter.** Ergebnis stets als „**kommt laut deinen Angaben in Frage**" ausgeben — **du entscheidest selbst**.
