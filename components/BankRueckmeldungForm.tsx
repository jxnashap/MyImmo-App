    ...
    >
      ...
      <div className="field">
        ...
        <textarea name="nachricht" required maxLength={4000} rows={4}
          style={{ width: "100%", background: "var(--bg3)", border: "1px solid var(--feld-rand)", borderRadius: 7, padding: "9px 11px", color: "var(--text)", fontFamily: "var(--font-ui)", fontSize: 13, outline: "none", resize: "vertical" }} />
      </div>
      <div className="field">
